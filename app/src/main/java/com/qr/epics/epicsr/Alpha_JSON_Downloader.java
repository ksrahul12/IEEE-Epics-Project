...
public class Alpha_JSON_Downloader implements  Runnable  {

    public Alpha_JSON_Downloader.download_complete caller;
    ...
    Alpha_JSON_Downloader(Alpha_JSON_Downloader.download_complete caller) {
        this.caller = caller;
    }
